...
from .views import RecordViewSet, RCommentViewSet, RecordRCommentViewSet, CardViewSet, Upload_imageViewSet
...
urlpatterns = [
    ...
    path("", include(upload_image_router.urls)), #5. Upload_image
