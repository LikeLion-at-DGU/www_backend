    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=Record.models.image_upload_path)),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('url', models.ImageField(upload_to=Record.models.image_upload_path)),
            ],
        ),
        migrations.CreateModel(
            name='Record',
            fields=[
                ...
                ('card_photo_1', models.ImageField(upload_to=Record.models.image_upload_path)),
                ('card_photo_2', models.ImageField(null=True, upload_to=Record.models.image_upload_path)),
                ('card_photo_3', models.ImageField(null=True, upload_to=Record.models.image_upload_path)),
